    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-2" dir="rtl">أنشئ حسابك</p>
        </div>

        <div className="bg-card border border-border rounded-3xl p-7 shadow-sm">
          <form action={action} className="space-y-4">
            {state.error && (
              <div className="p-3 rounded-xl bg-destructive/10 border border-destructive/20 text-destructive text-sm text-center" dir="rtl">
                {state.error}
              </div>
            )}
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground" dir="rtl">الاسم الظاهر</label>
                <input
                  name="display_name"
                  type="text"
                  placeholder="اسمك"
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-foreground" dir="rtl">البريد الإلكتروني</label>
              <input
                name="email"
                type="email"
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-foreground" dir="rtl">كلمة المرور</label>
